...
const Scene = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      undefined,
      () => {
        const fallback = new THREE.DataTexture(new Uint8Array([10, 10, 15, 255]), 1, 1)
...
export const Hero3DWebGL = () => {
  ...
  useEffect(() => {
    ...
    const t2 = setTimeout(() => setSloganVisible(true), 1100)
  ...
  return (
    <div className="h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-[60] pointer-events-none flex flex-col items-center justify-end pb-16 px-6 text-center">
        ...
        <div
          className={`mt-4 font-space-mono text-sm md:text-base xl:text-lg text-white/60 tracking-[0.3em] uppercase transition-all duration-700 ${sloganVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
